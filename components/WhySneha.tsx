...
export const WhySneha = () => {
  return (
    <section id="why-sneha" className="py-24 px-4 sm:px-6 lg:px-8 relative bg-[#0a1e36]/70 border-t border-b border-cyan-500/20">
      <div className="max-w-7xl mx-auto">
        ...
        <BentoGrid>
          ...
          <BentoGridItem
            className="md:col-span-2 bg-gradient-to-br from-[#0e2a4d]/95 to-[#0b213c]/95 border-cyan-500/40"
            ...
            header={
              <div className="h-28 rounded-xl bg-gradient-to-r from-cyan-950/40 via-[#132f54]/60 to-cyan-900/40 border border-cyan-500/30 p-4 flex items-center justify-around">
                <div className="text-center">
                  <div className="text-xs text-rose-400 font-semibold">Online Aggregator</div>
                  <div className="text-[10px] text-sky-300/60">IVR Robot & Hold Music</div>
                </div>
                <div className="text-xl font-bold text-cyan-300">VS</div>
                <div className="text-center">
                  <div className="text-sm text-cyan-300 font-bold">Sneha (Personal Advisor)</div>
                  <div className="text-[10px] text-cyan-300/80">Direct Call & WhatsApp</div>
                </div>
              </div>
            }
          />
          ...
          <BentoGridItem
            ...
            header={
              <div className="h-28 rounded-xl bg-[#0b213c]/80 border border-cyan-900/40 p-4 flex flex-col justify-center items-center">
          ...
          <BentoGridItem
            ...
            header={
              <div className="h-28 rounded-xl bg-[#0b213c]/80 border border-cyan-900/40 p-4 flex flex-col justify-center items-center">
                <div className="text-2xl font-black text-amber-400">₹0 Extra</div>
                <span className="text-[10px] text-sky-300/70 mt-1">Regulated IRDAI premium tariffs</span>
              </div>
            }
          />
          ...
          <BentoGridItem
            ...
            header={
              <div className="h-28 rounded-xl bg-[#0b213c]/80 border border-cyan-900/40 p-4 flex flex-col justify-center items-center">
                <div className="text-xl font-bold text-cyan-200">Zero Room Rent Penalties</div>
                <span className="text-[11px] text-cyan-300 font-semibold mt-1">100% Bill Clearance</span>
              </div>
            }
          />
          ...
          <BentoGridItem
            ...
            header={
              <div className="h-28 rounded-xl bg-[#0b213c]/80 border border-cyan-900/40 p-4 flex flex-col justify-center items-center">
                <div className="text-xl font-bold text-cyan-200">Direct WhatsApp with Sneha</div>
                <span className="text-[11px] text-cyan-300 font-semibold mt-1">Lifelong Policy Assistance</span>
              </div>
            }
          />
        </BentoGrid>
