...
export function ButtonWithBorder({
  ...
  return (
    <Component
      className={cn(
        "bg-transparent relative text-xl p-[1.5px] overflow-hidden group cursor-pointer active:scale-95 transition-transform",
        containerClassName
      )}
      style={{
    ...
    >
      ...
      >
        <MovingBorder duration={duration} rx="30%" ry="30%">
          <div
            className={cn(
              "h-20 w-20 opacity-[0.8] bg-[radial-gradient(#38bdf8_40%,#10b981_60%,transparent_70%)]",
              borderClassName
            )}
          />
        </MovingBorder>
